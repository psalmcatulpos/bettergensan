# General Santos City Government: Free Health Services

The General Santos City Government offers free **check-ups, medicines, and vaccines** through the City Health Office (CHO), barangay health centers, and partner programs.
...
| Medicines for indigent seniors [TO BE VERIFIED — local program name] | Partner pharmacies [TO BE VERIFIED] | Pharmacy hours     | Must be an indigent senior citizen, bona fide resident; coverage caps [TO BE VERIFIED] |
...
| ----------------- | -------------------------------------------------------- | ---------------------------- | ------------------------------- | -------------------------------------------------------- |
| Children          | BCG, Pentavalent, OPV/IPV, MMR, Hepatitis B, PCV13 (EPI) | Barangay Health Centers      | Typically Wednesdays, 8 AM–4 PM [TO BE VERIFIED] | ECCD card (first-timers can get one onsite)              |
...
| Animal bite cases | Anti-rabies vaccine (first dose free)                    | Animal Bite Treatment Center [TO BE VERIFIED] | Clinic hours                    | Proof of General Santos City residency (e.g., voter's certificate) |
...
6. **Senior citizen medicines** → Visit participating partner pharmacies; follow program guidelines [TO BE VERIFIED — local program name].
