# Renew Permits and Pay Local Business Taxes — General Santos City
...
- All businesses operating in General Santos City: **sole proprietors, partnerships, corporations, NGOs, cooperatives, online sellers with local presence**, and professionals with a business office.
...
1. **Pre-screening / Queuing**
   - Go to the **Business One-Stop Shop (BOSS)** during the renewal period [TO BE VERIFIED — confirm BOSS location in GenSan].
...
- Some transactions may be done via the city's **online business portal** or **pre-assessment** channels (if announced). Check [gensantos.gov.ph](https://gensantos.gov.ph/) for updates [TO BE VERIFIED — confirm if online filing is available].
