...
const HousingLandUse: React.FC = () => {
  ...
  const referenceHeadRef = useReveal();
  const referenceGridRef = useReveal();
  ...
  return (
    <>
      ...
      {/* ---------- Programs at a glance ---------- */}
      <PageSection background="white" tier="secondary">
        <div ref={referenceHeadRef} className="reveal">
        <SectionHeading
          tier="secondary"
          icon={ClipboardList}
          eyebrow="At a glance"
        ...
        <div ref={referenceGridRef} className="reveal overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm shadow-gray-900/[0.04]">
